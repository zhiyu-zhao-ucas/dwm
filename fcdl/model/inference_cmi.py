...
from fcdl.model.inference import Inference
from fcdl.model.inference_utils import reset_layer, forward_network, forward_network_batch, get_state_abstraction
from fcdl.utils.utils import to_numpy, preprocess_obs, postprocess_obs
...
class InferenceCMI(Inference):
    ...
    def forward_with_feature(self, feature, actions, mask=None,
                             forward_mode=("full", "causal"), abstraction_mode=False):
        """
